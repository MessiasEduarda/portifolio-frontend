...
const WHATSAPP = `https://wa.me/5511953311935?text=${encodeURIComponent('Olá! Tenho interesse em desenvolver um App Mobile. Pode me passar mais informações?')}`;
    ...
    <>
      ...
      <Page>
        <Hero>
          <Inner>
            <FadeIn direction="up" duration={800}>
              ...
              <HeroSub>Mesma experiência em qualquer tela — aplicações multiplataforma com React Native e Expo, integrações com APIs externas e funcionalidades em tempo real.</HeroSub>
        ...
        <CTA><Inner><FadeIn direction="up" duration={800}>
          ...
          <CTATitle>Pronto para levar seu produto <strong>para o mobile?</strong></CTATitle>
          <CTASub>Me conta a ideia e eu te mostro o caminho técnico mais rápido para o mercado.</CTASub>
